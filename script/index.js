...
function createRow(objItems) {
  return `
  <tr>
    <td class="table__cell"></td>
    <td class="table__cell table__cell_left table__cell_name" data-id="24601654816512">
      <span class="table__cell-id">${objItems.id}</span>
      ${objItems.title}</td>
    <td class="table__cell table__cell_left">${objItems.description}</td>
    <td class="table__cell">${objItems.units}</td>
    <td class="table__cell">${objItems.count}</td>
    <td class="table__cell">${objItems.price}</td>
    <td class="table__cell">${objItems.discount}</td>
...
function renderGoods() {
  ...
  for (let i = 0; i < base.items.length; i++) {
    htmlRow += createRow(base.items[i])
  }
  document.querySelector('.table__body').innerHTML = htmlRow;
}
